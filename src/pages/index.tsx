                ...
                <main className={'bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40'}>
                    <section className={'min-h-screen'}>
                        <nav className={'py-10 mb-12 flex justify-between dark:text-white'}>
                            <h1 className={'text-xl font-burtons'}>developbyMK</h1>
                        ...
                        <div className={'text-center p-10 py-10'}>
                            <h2 className={'text-5xl py-2 text-teal-600 font-medium dark:text-teal-400 md:text-6xl'}>Magno
                                Kelly</h2>
                            <h3 className={'text-2xl py-2 dark:text-white md:text-3xl'}>Software Engineer | Front-End React
                                Heated | Back-End PhP(Laravel) Enthusiastic </h3>
                            <p className={'text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl'}>
                                Freelancer technology passionate based in Rio de Janeiro - Brazil, committed to working with
                    ...
                    <section>
                        <div>
                            ...
                            <p className={'text-md py-2 leading-8 text-gray-800 dark:text-gray-200'}>
                                ...
                                brainstorming <span className={'text-teal-500'}> creative solutions</span>, I approach every
